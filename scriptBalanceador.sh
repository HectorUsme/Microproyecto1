...
sudo sed -i "s/No server is available to handle this request/ El servidor se encuentra completamente no disponible, mientras tanto puede consultar el dolar hoy/g" /etc/haproxy/errors/503.http
